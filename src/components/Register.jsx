...
class Register extends React.Component {
    render() {
        return (
            <div className="is-fullwidth grey-background is-fullheight">
                <div className="form-container p-3">
                    <img src={logo} alt="Conexion Apptiva Logo"/>
                    <div id="mc_embed_signup">
                        <form action="https://gmail.us6.list-manage.com/subscribe/post?u=1a2ccc7db22d8e1819931040c&amp;id=d6adb2414e" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" className="validate" target="_blank" noValidate>
                            <div id="mc_embed_signup_scroll">
                                ...
                                /></div>
                                <div className="clear">
                                    <input type="submit" value="Registrarme" name="subscribe" id="mc-embedded-subscribe" className="button is-primary" />
                                    <Link to="/">
